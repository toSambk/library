...
public class AuthorBookDao {
    ...
    public void addDependency(Book book, Author author) throws SQLException {
        try(PreparedStatement preparedStatement = connection.prepareStatement("insert into book_author(book_id, author_id) VALUES (?, ?)")) {
    ...
    boolean bookContainsAuthor(Book book, Author author) throws SQLException {
